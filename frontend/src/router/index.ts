  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'vouchers', name: 'admin-vouchers', component: () => import('@/pages/admin/AdminVouchersPage.vue'), meta: { permissions: ['promotions.read'] } },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'vouchers', name: 'partner-vouchers', component: () => import('@/pages/restaurant/RestaurantVouchersPage.vue'), meta: { permissions: ['promotions.read'] } },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'vouchers', name: 'restaurant-vouchers', component: () => import('@/pages/restaurant/RestaurantVouchersPage.vue'), meta: { permissions: ['promotions.read'] } },
